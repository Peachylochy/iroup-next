...
export function MouAttachmentsCard({
  agreementId,
  attachments,
  access,
  isDeleted,
  ...
  return (
    <Card id="attachments" className="border-border/60 scroll-mt-6">
      ...
      <CardContent>
        {showCreatedNotice && (
          <div className="mb-4 rounded-md bg-emerald-50 p-3 text-sm text-emerald-800 dark:bg-emerald-950/40 dark:text-emerald-200">
            บันทึกร่าง MOU แล้ว — แนบไฟล์ MOU ฉบับนี้ได้ทันทีจากปุ่มด้านบน
          </div>
        )}
        {errorMsg && (
